# SistemadeEmpleados
Aplicación web de gestión de empleados en la que puedes: añadir, modificar y eliminar empleados respectivamente. En dicha vista podrás observar el nombre, departamento y salario del empleado.
